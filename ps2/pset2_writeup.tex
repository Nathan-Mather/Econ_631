...
$$p_1 = mc_1 - [\int \tilde{s}_1 dF(v) - \alpha (p_2 - mc_2)\int \tilde{s}_1\tilde{s}_2dF(v)][-\alpha \int \tilde{s}_1(1-\tilde{s}_1)dF(v)]^{-1}$$


$$p_2 = mc_2 - [\int \tilde{s}_2 dF(v) - \alpha (p_1 - mc_1)\int \tilde{s}_2\tilde{s}_1dF(v)][-\alpha \int \tilde{s}_2(1-\tilde{s}_2)dF(v)]^{-1}$$
